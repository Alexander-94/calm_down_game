...
int main()
{
	...
	*/
	IAnimatedMesh* mesh = smgr->getMesh("C:/Users/Alexa/Desktop/calm_down/calm_down/calm_down/Release/media/sydney.md2");
	if (!mesh)
	{
		device->drop();
		return 1;
	...
	*/
	if (node)
	{
		...
		node->setMaterialTexture( 0, driver->getTexture("C:/Users/Alexa/Desktop/calm_down/calm_down/calm_down/Release/media/sydney.bmp") );
	}
